    ...
    <main className="min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 text-[14.5px] leading-relaxed text-zinc-300">
        ...
        <div className="mt-1">
          ...
          <Row a="Activate companies directory" b="224 ventures: name, cohort year, hub, verticals, fellows, websites, and the human-written Critical Need / Technology Vision / Potential Impact." c="Softr app over an Airtable base; harvested via headless browser (JS-rendered). The complete public directory (re-harvested, unchanged at 224). Activate's marketing pages cite ~235 total, a broader count that includes ventures not in the public directory." />
          <Row a="Activate fellows directory" b="292 fellows: biography, cohort, hub, company, LinkedIn. The bios state degree + university for ~92%." c="Separate Softr/Airtable table, same harvest. The complete public directory; Activate cites ~294 total." />
